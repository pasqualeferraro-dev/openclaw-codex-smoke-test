...
const SpectralGhostBackground = dynamic(
  () => import("../components/spectral/SpectralGhostBackground"),
  { ssr: false },
);
const enableSpectralBackground = process.env.NODE_ENV !== "test";
...
export default function HomePage() {
  ...
  return (
    <ThemeProvider>
      <div id="top" className="relative isolate min-h-dvh">
        {enableSpectralBackground ? <SpectralGhostBackground /> : null}
          ...
          <main>
            <section className="relative flex min-h-[calc(100dvh-64px)] items-center overflow-hidden">
              ...
              <div className="mx-auto w-full max-w-6xl px-4 py-16 md:px-6 md:py-20">
                <motion.div {...heroMotion} className="max-w-2xl">
              ...
              <div className="pointer-events-none absolute inset-x-0 bottom-0 h-28 bg-gradient-to-b from-transparent to-white/95 dark:to-slate-950/95" />
            </section>

            <div className="relative border-t border-slate-200/60 bg-white/95 dark:border-white/10 dark:bg-slate-950/95">
